...
class _ContactPageState extends State<ContactPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          Image.asset('assets/home/bg-clouds.png', width: width, fit: BoxFit.cover),
          SingleChildScrollView(
            child: Stack(children: [
              SizedBox(height: 650, child: Center(child: Image.asset('assets/home/bg-try-again.png', height: height * .7))),
              Padding(
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text('Send us what you think: ', style: TextStyle(fontSize: 23)),
                      SizedBox(
                        height: 300,
                        width: 270,
                        child: TextField(
              ...
              Positioned(
                ...
                bottom: 80,
                child: IconButton(
                  icon: Image.asset('assets/settings/btn-send.png', height: 100),
